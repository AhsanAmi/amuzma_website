...
const OPERATIONAL_TABS_13CR: OperationalTab[] = [
  {
    ...
    icon: "/media/New-Project-9.png",
    image: "/media/cnc-1-2-1024x640-1-removebg-preview.png",
  },
  {
    ...
    description:
      "The machine performs smooth and high-speed cutting with consistent feed rates. Its advanced motion control system ensures accurate tool paths and efficient material processing.",
    icon: "/media/New-Project-10.png",
    image: "/media/cnc-1-3-1024x640-1-removebg-preview.png",
  },
  {
...
const RDC3800_OPERATIONAL_IMAGE = "/media/Dusy-Collector-RDC3800-1.png";
...
const OPERATIONAL_TABS_30SM: OperationalTab[] = [
  {
    ...
    icon: "/media/New-Project-9.png",
    image: "/media/material_massivholz7.jpg",
  },
  {
    label: "Performance",
    heading: "Production",
...
const OPERATIONAL_TABS_41PF: OperationalTab[] = [
  {
    ...
    icon: "/media/New-Project-9.png",
    image: "/media/Solid-Wood-planer-working.jpg",
  },
  {
    ...
    icon: "/media/Wood-Components-1.png",
    image: "/media/Wood-Components-planer-working.jpg",
  },
  {
...
const OPERATIONAL_TABS_41TH: OperationalTab[] = [
  ...
  },
  {
    ...
    icon: "/media/New-Project-11.png",
    image: "/media/Thicknesser-25-Elite-41th-1-1.jpg",
  },
  {
    label: "Supported",
